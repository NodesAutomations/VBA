...
Binding is a process of coupling the object variable with its content. After the binding, the variable represents the object and allows it to get access to the methods and data of the object.
 For detailed explanation of the difference between ‘Early binding’ and ‘Late Binding’ please read the following articles:[Early vs. Late Binding](https://wordmvp.com/FAQs/InterDev/EarlyvsLateBinding.htm)[Using early binding and late binding in Automation](https://docs.microsoft.com/en-us/previous-versions/office/troubleshoot/office-developer/binding-type-available-to-automation-clients)
...
![https://s3-us-west-2.amazonaws.com/secure.notion-static.com/eb65bbbf-33a9-41a2-9fb1-a1af5ece4516/option_explicit_directive.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/eb65bbbf-33a9-41a2-9fb1-a1af5ece4516/option_explicit_directive.png)
